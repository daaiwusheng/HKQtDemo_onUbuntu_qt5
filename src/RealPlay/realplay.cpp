...
/*******************************************************************
   ...
   Description:   ���Ŵ��ڵĹ��캯��
     Parameter:   (IN)   TreeModel**  model  
                  (IN)   const QModelIndex * index         ����ģ��
                  (IN)   QList<DeviceData>* tree           ģ������
                  (IN)   int* userid                       ��½��ȡ��UserID
                  (IN)   NET_DVR_DEVICEINFO_V30* devinfo   ҪԤ�����豸��������Ϣ
                  (IN)   int* channelnum                   ҪԤ����ͨ����
                  (IN)   int *channelmode                  Ԥ�����õĴ���Э��
                  (IN)   LogTable * table                  ��־����
                  (IN)   QWidget *parent                   
        Return:   none
**********************************************************************/
...
void RealPlay::RealPlayContextResponse(const QPoint &pos)
{
    ...
    //���������Ҽ�ѡ��
    QAction *fullFrameAction = m_rpmenu->addAction("������ʾ");
    QAction *fullScreenAction = m_rpmenu->addAction("ȫ����ʾ");
	QAction *normalFrameAction = m_rpmenu->addAction("������ʾ");
	//���ù�����Ӧ����
...
/*******************************************************************
   ...
   Description:   ����һ·ͨ��������
     Parameter:   (IN)   int devicerow     Ҫ���ŵ��豸��qlistdevice�е����к�
                  (IN)   int channelrow    Ҫ���ŵ�ͨ����ĳ���豸�ڵ��µ�����.
...
int RealPlay::realPlayEncapseInterface(int devicerow, int channelrow, NET_DVR_CLIENTINFO *clientinfo)
{
    ...
    qDebug("Demo---Protocal:%d", struPlayInfo.dwLinkMode);
    if (realhandle < 0) 
    {	
        QMessageBox::information(this, tr("NET_DVR_RealPlay_V40 error"), tr("SDK_LASTERROR=%1").arg(NET_DVR_GetLastError())); 
		return 0;
    }
	else
	{	
		if ((*it_channel).getChannelNum()>32)
		{
			...
			{
				QMessageBox::information(this,tr("NET_DVR_RealPlay_V40 error"), \
            		tr("��ͨ�������ߣ�Ԥ��ʧ��")); 
 ...
 *        Description         :  ���Ŵ�������ֵ
 *        Input               :  int index ʵ�ʲ��Ŵ���Ϊindex+1��ƽ��
 *        Output              :  none
 *        Return              :  none
*************************************************************************/
void RealPlay::on_comboBox_windowsnum_currentIndexChanged (int index)
{
    ...
    {
        QMessageBox::information(this,tr("���ó���"),
            tr("����ֹͣ�������޸Ĵ򿪴�����"));
        return;
    }
 ...
 *        Description         :  defaultparameter ����Ĭ�ϲ���
 *        Input               :  none 
 *        Output              :  none
 *        Return              :  none
*************************************************************************/
