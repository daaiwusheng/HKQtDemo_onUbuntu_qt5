...
public:
    ...
    void setupUi(QWidget *CNfsParamsClass)
    {
        if (CNfsParamsClass->objectName().isEmpty())
            CNfsParamsClass->setObjectName(QStringLiteral("CNfsParamsClass"));
        ...
        comboDiskNum->setObjectName(QStringLiteral("comboDiskNum"));
    ...
    {
        CNfsParamsClass->setWindowTitle(QApplication::translate("CNfsParamsClass", "CNfsParams", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CNfsParamsClass", "Confirm", Q_NULLPTR));
        btnExit->setText(QApplication::translate("CNfsParamsClass", "Cannel", Q_NULLPTR));
        label_2->setText(QApplication::translate("CNfsParamsClass", "NFS IP address", Q_NULLPTR));
        label_3->setText(QApplication::translate("CNfsParamsClass", "Directory", Q_NULLPTR));
        label_4->setText(QApplication::translate("CNfsParamsClass", "Disk No.", Q_NULLPTR));
        btnRefresh->setText(QApplication::translate("CNfsParamsClass", "Update", Q_NULLPTR));
    } // retranslateUi
