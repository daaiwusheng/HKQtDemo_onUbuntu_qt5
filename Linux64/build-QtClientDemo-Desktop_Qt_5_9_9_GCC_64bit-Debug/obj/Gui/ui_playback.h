...
public:
    ...
    void setupUi(QWidget *PlayBackClass)
    {
        if (PlayBackClass->objectName().isEmpty())
            PlayBackClass->setObjectName(QStringLiteral("PlayBackClass"));
        ...
        lineEdit_1_downfilename->setObjectName(QStringLiteral("lineEdit_1_downfilename"));
        ...
        lineEdit_1_cardSID->setObjectName(QStringLiteral("lineEdit_1_cardSID"));
        lineEdit_1_cardSID->setGeometry(QRect(400, 50, 231, 20));
        pushButton_playback_start_1 = new QPushButton(tab);
        pushButton_playback_start_1->setObjectName(QStringLiteral("pushButton_playback_start_1"));
        ...
        dateTimeEdit_1_start->setObjectName(QStringLiteral("dateTimeEdit_1_start"));
        ...
        pushButton_playback_picture_1->setObjectName(QStringLiteral("pushButton_playback_picture_1"));
        ...
        pushButton_playback_stop_1->setObjectName(QStringLiteral("pushButton_playback_stop_1"));
        ...
        tableWidget_1_filelist->setObjectName(QStringLiteral("tableWidget_1_filelist"));
        tableWidget_1_filelist->setGeometry(QRect(10, 91, 321, 411));
        comboBox_1_fileattr = new QComboBox(tab);
        comboBox_1_fileattr->setObjectName(QStringLiteral("comboBox_1_fileattr"));
        ...
        dateTimeEdit_1_stop->setObjectName(QStringLiteral("dateTimeEdit_1_stop"));
        ...
        pushButton_playback_frame_1->setObjectName(QStringLiteral("pushButton_playback_frame_1"));
        ...
        horizontalSlider_1_playbackprocess->setObjectName(QStringLiteral("horizontalSlider_1_playbackprocess"));
        ...
        checkBox_1_carno->setObjectName(QStringLiteral("checkBox_1_carno"));
        checkBox_1_carno->setGeometry(QRect(240, 50, 81, 17));
        pushButton_1_download = new QPushButton(tab);
        pushButton_1_download->setObjectName(QStringLiteral("pushButton_1_download"));
        ...
        lineEdit_1_filetotalsize->setObjectName(QStringLiteral("lineEdit_1_filetotalsize"));
        lineEdit_1_filetotalsize->setGeometry(QRect(90, 550, 101, 20));
        horizontalSlider_playback_volume_1 = new QSlider(tab);
        horizontalSlider_playback_volume_1->setObjectName(QStringLiteral("horizontalSlider_playback_volume_1"));
        ...
        pushButton_1_lock->setObjectName(QStringLiteral("pushButton_1_lock"));
        ...
        lineEdit_1_downoffset->setObjectName(QStringLiteral("lineEdit_1_downoffset"));
        ...
        pushButton_playback_fast_1->setObjectName(QStringLiteral("pushButton_playback_fast_1"));
        ...
        pushButton_1_search->setObjectName(QStringLiteral("pushButton_1_search"));
        pushButton_1_search->setGeometry(QRect(20, 510, 75, 21));
        pushButton_1_downsave = new QPushButton(tab);
        pushButton_1_downsave->setObjectName(QStringLiteral("pushButton_1_downsave"));
        ...
        pushButton_playback_pos_1->setObjectName(QStringLiteral("pushButton_playback_pos_1"));
        ...
        comboBox_1_filetype->setObjectName(QStringLiteral("comboBox_1_filetype"));
        comboBox_1_filetype->setGeometry(QRect(130, 20, 151, 21));
        pushButton_1_downstopsave = new QPushButton(tab);
        pushButton_1_downstopsave->setObjectName(QStringLiteral("pushButton_1_downstopsave"));
        pushButton_1_downstopsave->setGeometry(QRect(270, 550, 71, 23));
        pushButton_playback_slow_1 = new QPushButton(tab);
        pushButton_playback_slow_1->setObjectName(QStringLiteral("pushButton_playback_slow_1"));
        ...
        lineEdit_1_pbprocess->setObjectName(QStringLiteral("lineEdit_1_pbprocess"));
        lineEdit_1_pbprocess->setGeometry(QRect(580, 580, 241, 20));
        pushButton_playback_volume_1 = new QPushButton(tab);
        pushButton_playback_volume_1->setObjectName(QStringLiteral("pushButton_playback_volume_1"));
        ...
        pushButton_playback_frame_2->setObjectName(QStringLiteral("pushButton_playback_frame_2"));
        ...
        pushButton_2_del->setObjectName(QStringLiteral("pushButton_2_del"));
        pushButton_2_del->setGeometry(QRect(140, 550, 75, 23));
        pushButton_playback_fast_2 = new QPushButton(tab_2);
        pushButton_playback_fast_2->setObjectName(QStringLiteral("pushButton_playback_fast_2"));
        ...
        dateTimeEdit_2_start->setObjectName(QStringLiteral("dateTimeEdit_2_start"));
        ...
        pushButton_2_delall->setObjectName(QStringLiteral("pushButton_2_delall"));
        pushButton_2_delall->setGeometry(QRect(250, 550, 75, 23));
        dateTimeEdit_2_stop = new QDateTimeEdit(tab_2);
        dateTimeEdit_2_stop->setObjectName(QStringLiteral("dateTimeEdit_2_stop"));
        dateTimeEdit_2_stop->setGeometry(QRect(660, 20, 151, 22));
        pushButton_playback_slow_2 = new QPushButton(tab_2);
        pushButton_playback_slow_2->setObjectName(QStringLiteral("pushButton_playback_slow_2"));
        ...
        pushButton_playback_picture_2->setObjectName(QStringLiteral("pushButton_playback_picture_2"));
        ...
        pushButton_playback_pos_2->setObjectName(QStringLiteral("pushButton_playback_pos_2"));
        ...
        comboBox_2_filetype->setObjectName(QStringLiteral("comboBox_2_filetype"));
        comboBox_2_filetype->setGeometry(QRect(190, 20, 121, 21));
        checkBox_2_all = new QCheckBox(tab_2);
        checkBox_2_all->setObjectName(QStringLiteral("checkBox_2_all"));
        checkBox_2_all->setGeometry(QRect(40, 20, 51, 21));
        pushButton_2_search = new QPushButton(tab_2);
        pushButton_2_search->setObjectName(QStringLiteral("pushButton_2_search"));
        ...
        pushButton_playback_start_2->setObjectName(QStringLiteral("pushButton_playback_start_2"));
        ...
        horizontalSlider_playback_process_2->setObjectName(QStringLiteral("horizontalSlider_playback_process_2"));
        ...
        tableWidget_2_localfilist->setObjectName(QStringLiteral("tableWidget_2_localfilist"));
        tableWidget_2_localfilist->setGeometry(QRect(10, 70, 341, 471));
        horizontalSlider_playback_volume_2 = new QSlider(tab_2);
        horizontalSlider_playback_volume_2->setObjectName(QStringLiteral("horizontalSlider_playback_volume_2"));
        ...
        pushButton_playback_stop_2->setObjectName(QStringLiteral("pushButton_playback_stop_2"));
        ...
        horizontalSlider_playback_volume_3->setObjectName(QStringLiteral("horizontalSlider_playback_volume_3"));
        ...
        pushButton_playback_fast_3->setObjectName(QStringLiteral("pushButton_playback_fast_3"));
        ...
        pushButton_3_save->setObjectName(QStringLiteral("pushButton_3_save"));
        pushButton_3_save->setGeometry(QRect(650, 200, 71, 31));
        dateTimeEdit_3_start = new QDateTimeEdit(tab_3);
        dateTimeEdit_3_start->setObjectName(QStringLiteral("dateTimeEdit_3_start"));
        dateTimeEdit_3_start->setGeometry(QRect(120, 20, 141, 21));
        pushButton_playback_pos_3 = new QPushButton(tab_3);
        pushButton_playback_pos_3->setObjectName(QStringLiteral("pushButton_playback_pos_3"));
        ...
        pushButton_playback_slow_3->setObjectName(QStringLiteral("pushButton_playback_slow_3"));
        ...
        pushButton_playback_picture_3->setObjectName(QStringLiteral("pushButton_playback_picture_3"));
        ...
        pushButton_playback_start_3->setObjectName(QStringLiteral("pushButton_playback_start_3"));
        ...
        pushButton_playback_stop_3->setObjectName(QStringLiteral("pushButton_playback_stop_3"));
        ...
        pushButton_playback_frame_3->setObjectName(QStringLiteral("pushButton_playback_frame_3"));
        ...
        pushButton_playback_volume_3->setObjectName(QStringLiteral("pushButton_playback_volume_3"));
    ...
    {
        PlayBackClass->setWindowTitle(QApplication::translate("PlayBackClass", "PlayBack", Q_NULLPTR));
        pushButton_playback_start_1->setText(QApplication::translate("PlayBackClass", "play", Q_NULLPTR));
        label_5->setText(QApplication::translate("PlayBackClass", "card No.", Q_NULLPTR));
        pushButton_playback_picture_1->setText(QApplication::translate("PlayBackClass", "snap", Q_NULLPTR));
        pushButton_playback_stop_1->setText(QApplication::translate("PlayBackClass", "stop", Q_NULLPTR));
        label_6->setText(QApplication::translate("PlayBackClass", "offset", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget_1_filelist->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("PlayBackClass", "file name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget_1_filelist->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("PlayBackClass", "size", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget_1_filelist->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("PlayBackClass", "start time", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget_1_filelist->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("PlayBackClass", "end time", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget_1_filelist->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("PlayBackClass", "property", Q_NULLPTR));
        comboBox_1_fileattr->clear();
        comboBox_1_fileattr->insertItems(0, QStringList()
         << QApplication::translate("PlayBackClass", "all", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "unlock", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "lock", Q_NULLPTR)
        );
        label_4->setText(QApplication::translate("PlayBackClass", "file length", Q_NULLPTR));
        pushButton_playback_frame_1->setText(QApplication::translate("PlayBackClass", "frame", Q_NULLPTR));
        checkBox_1_carno->setText(QApplication::translate("PlayBackClass", "by card No.", Q_NULLPTR));
        pushButton_1_download->setText(QApplication::translate("PlayBackClass", "download", Q_NULLPTR));
        label_10->setText(QApplication::translate("PlayBackClass", "download file name", Q_NULLPTR));
        pushButton_1_lock->setText(QApplication::translate("PlayBackClass", "lock", Q_NULLPTR));
        label->setText(QApplication::translate("PlayBackClass", "file property", Q_NULLPTR));
        label_3->setText(QApplication::translate("PlayBackClass", "end", Q_NULLPTR));
        pushButton_playback_fast_1->setText(QApplication::translate("PlayBackClass", "fast", Q_NULLPTR));
        pushButton_1_search->setText(QApplication::translate("PlayBackClass", "search", Q_NULLPTR));
        pushButton_1_downsave->setText(QApplication::translate("PlayBackClass", "buckup", Q_NULLPTR));
        label_2->setText(QApplication::translate("PlayBackClass", "record type", Q_NULLPTR));
        pushButton_playback_pos_1->setText(QApplication::translate("PlayBackClass", "reset", Q_NULLPTR));
        label_7->setText(QApplication::translate("PlayBackClass", "start", Q_NULLPTR));
        comboBox_1_filetype->clear();
        comboBox_1_filetype->insertItems(0, QStringList()
         << QApplication::translate("PlayBackClass", "all", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "schedule", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "motion dectect", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "alarm", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "alarm or motion dectect", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "alarm anf motion dectect", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "command", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "manual record", Q_NULLPTR)
        );
        pushButton_1_downstopsave->setText(QApplication::translate("PlayBackClass", "stop backup", Q_NULLPTR));
        pushButton_playback_slow_1->setText(QApplication::translate("PlayBackClass", "slow", Q_NULLPTR));
        pushButton_playback_volume_1->setText(QApplication::translate("PlayBackClass", "open volume", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PlayBackClass", "Tab 1", Q_NULLPTR));
        label_9->setText(QApplication::translate("PlayBackClass", "file type", Q_NULLPTR));
        pushButton_playback_frame_2->setText(QApplication::translate("PlayBackClass", "frame", Q_NULLPTR));
        pushButton_2_del->setText(QApplication::translate("PlayBackClass", "delete", Q_NULLPTR));
        pushButton_playback_fast_2->setText(QApplication::translate("PlayBackClass", "fast", Q_NULLPTR));
        pushButton_2_delall->setText(QApplication::translate("PlayBackClass", "delete all", Q_NULLPTR));
        pushButton_playback_slow_2->setText(QApplication::translate("PlayBackClass", "slow", Q_NULLPTR));
        pushButton_playback_picture_2->setText(QApplication::translate("PlayBackClass", "snap", Q_NULLPTR));
        label_8->setText(QApplication::translate("PlayBackClass", "start", Q_NULLPTR));
        pushButton_playback_pos_2->setText(QApplication::translate("PlayBackClass", "reset", Q_NULLPTR));
        comboBox_2_filetype->clear();
        comboBox_2_filetype->insertItems(0, QStringList()
         << QApplication::translate("PlayBackClass", "normal", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "alarm", Q_NULLPTR)
         << QApplication::translate("PlayBackClass", "download", Q_NULLPTR)
        );
        checkBox_2_all->setText(QApplication::translate("PlayBackClass", "all", Q_NULLPTR));
        pushButton_2_search->setText(QApplication::translate("PlayBackClass", "search", Q_NULLPTR));
        label_11->setText(QApplication::translate("PlayBackClass", "end", Q_NULLPTR));
        pushButton_playback_start_2->setText(QApplication::translate("PlayBackClass", "play", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget_2_localfilist->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QApplication::translate("PlayBackClass", "file name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidget_2_localfilist->horizontalHeaderItem(1);
        ___qtablewidgetitem6->setText(QApplication::translate("PlayBackClass", "size", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidget_2_localfilist->horizontalHeaderItem(2);
        ___qtablewidgetitem7->setText(QApplication::translate("PlayBackClass", "type", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidget_2_localfilist->horizontalHeaderItem(3);
        ___qtablewidgetitem8->setText(QApplication::translate("PlayBackClass", "start time", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget_2_localfilist->horizontalHeaderItem(4);
        ___qtablewidgetitem9->setText(QApplication::translate("PlayBackClass", "end time", Q_NULLPTR));
        pushButton_playback_stop_2->setText(QApplication::translate("PlayBackClass", "stop", Q_NULLPTR));
        pushButton_playback_volume_2->setText(QApplication::translate("PlayBackClass", "open volume", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PlayBackClass", "Tab 2", Q_NULLPTR));
        pushButton_3_download->setText(QApplication::translate("PlayBackClass", "downlosd", Q_NULLPTR));
        label_64->setText(QApplication::translate("PlayBackClass", "end", Q_NULLPTR));
        label_65->setText(QApplication::translate("PlayBackClass", "start", Q_NULLPTR));
        pushButton_playback_fast_3->setText(QApplication::translate("PlayBackClass", "fast", Q_NULLPTR));
        pushButton_3_save->setText(QApplication::translate("PlayBackClass", "backup", Q_NULLPTR));
        pushButton_playback_pos_3->setText(QApplication::translate("PlayBackClass", "reset", Q_NULLPTR));
        pushButton_playback_slow_3->setText(QApplication::translate("PlayBackClass", "slow", Q_NULLPTR));
        pushButton_playback_picture_3->setText(QApplication::translate("PlayBackClass", "snap", Q_NULLPTR));
        pushButton_playback_start_3->setText(QApplication::translate("PlayBackClass", "start", Q_NULLPTR));
        pushButton_playback_stop_3->setText(QApplication::translate("PlayBackClass", "stop", Q_NULLPTR));
        pushButton_playback_frame_3->setText(QApplication::translate("PlayBackClass", "frame", Q_NULLPTR));
        pushButton_playback_volume_3->setText(QApplication::translate("PlayBackClass", "open volume", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PlayBackClass", "Page", Q_NULLPTR));
    } // retranslateUi
