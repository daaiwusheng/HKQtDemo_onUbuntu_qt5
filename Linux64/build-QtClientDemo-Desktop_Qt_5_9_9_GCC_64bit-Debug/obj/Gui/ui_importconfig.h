...
public:
    ...
    void setupUi(QWidget *ImportConfigClass)
    {
        if (ImportConfigClass->objectName().isEmpty())
            ImportConfigClass->setObjectName(QStringLiteral("ImportConfigClass"));
        ...
        lineEdit_configfilename->setObjectName(QStringLiteral("lineEdit_configfilename"));
    ...
    {
        ImportConfigClass->setWindowTitle(QApplication::translate("ImportConfigClass", "ImportConfig", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("ImportConfigClass", "Device tree", Q_NULLPTR));
        label->setText(QApplication::translate("ImportConfigClass", "Export config file", Q_NULLPTR));
        label_2->setText(QApplication::translate("ImportConfigClass", "Import config file", Q_NULLPTR));
        label_3->setText(QApplication::translate("ImportConfigClass", "File path", Q_NULLPTR));
        label_4->setText(QApplication::translate("ImportConfigClass", "Save path", Q_NULLPTR));
        pushButton_browse->setText(QApplication::translate("ImportConfigClass", "Browse", Q_NULLPTR));
        pushButton_export->setText(QApplication::translate("ImportConfigClass", "Export", Q_NULLPTR));
        pushButton_import->setText(QApplication::translate("ImportConfigClass", "Copy to device selected", Q_NULLPTR));
        label_5->setText(QApplication::translate("ImportConfigClass", "Select one device", Q_NULLPTR));
        pushButton_exit->setText(QApplication::translate("ImportConfigClass", "Exit", Q_NULLPTR));
    } // retranslateUi
