...
public:
    ...
    void setupUi(QDialog *PtzCruiseClass)
    {
        if (PtzCruiseClass->objectName().isEmpty())
            PtzCruiseClass->setObjectName(QStringLiteral("PtzCruiseClass"));
        ...
        pushButton_deletecruisepoint->setObjectName(QStringLiteral("pushButton_deletecruisepoint"));
        ...
        pushButton_addcruisepoint->setObjectName(QStringLiteral("pushButton_addcruisepoint"));
        ...
        comboBox_ptzcruisepresetpoint->setObjectName(QStringLiteral("comboBox_ptzcruisepresetpoint"));
        comboBox_ptzcruisepresetpoint->setGeometry(QRect(210, 70, 91, 22));
        comboBox_ptzcruisetime = new QComboBox(PtzCruiseClass);
        comboBox_ptzcruisetime->setObjectName(QStringLiteral("comboBox_ptzcruisetime"));
        comboBox_ptzcruisetime->setGeometry(QRect(370, 70, 91, 22));
        comboBox_ptzcruisespeed = new QComboBox(PtzCruiseClass);
        comboBox_ptzcruisespeed->setObjectName(QStringLiteral("comboBox_ptzcruisespeed"));
    ...
    {
        PtzCruiseClass->setWindowTitle(QApplication::translate("PtzCruiseClass", "PtzCruise", Q_NULLPTR));
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:11pt;\">\345\267\241\350\210\252\350\267\257\345\276\204</span></p></body></html>", Q_NULLPTR));
        pushButton_exit->setText(QApplication::translate("PtzCruiseClass", "\351\200\200\345\207\272", Q_NULLPTR));
        pushButton_deletecruisepoint->setText(QApplication::translate("PtzCruiseClass", "\345\210\240\351\231\244\345\267\241\350\210\252\347\202\271", Q_NULLPTR));
        pushButton_addcruisepoint->setText(QApplication::translate("PtzCruiseClass", "\346\267\273\345\212\240\345\267\241\350\210\252\347\202\271", Q_NULLPTR));
        label->setText(QApplication::translate("PtzCruiseClass", "\345\267\241\350\210\252\347\202\271", Q_NULLPTR));
        label_2->setText(QApplication::translate("PtzCruiseClass", "\351\242\204\347\275\256\347\202\271", Q_NULLPTR));
        label_3->setText(QApplication::translate("PtzCruiseClass", "\346\227\266\351\227\264(\347\247\222)", Q_NULLPTR));
        label_4->setText(QApplication::translate("PtzCruiseClass", "\351\200\237\345\272\246", Q_NULLPTR));
    } // retranslateUi
