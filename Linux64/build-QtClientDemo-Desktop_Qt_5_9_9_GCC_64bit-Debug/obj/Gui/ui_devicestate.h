...
public:
    ...
    void setupUi(QWidget *DeviceStateClass)
    {
        if (DeviceStateClass->objectName().isEmpty())
            DeviceStateClass->setObjectName(QStringLiteral("DeviceStateClass"));
        ...
        label_totalconnum->setObjectName(QStringLiteral("label_totalconnum"));
        label_totalconnum->setGeometry(QRect(650, 30, 61, 20));
        label_devicestate = new QLabel(DeviceStateClass);
        label_devicestate->setObjectName(QStringLiteral("label_devicestate"));
        ...
        lineEdit_devicestate->setObjectName(QStringLiteral("lineEdit_devicestate"));
        ...
        lineEdit_totalconnum->setObjectName(QStringLiteral("lineEdit_totalconnum"));
        ...
        channeltableWidget->setObjectName(QStringLiteral("channeltableWidget"));
    ...
    {
        DeviceStateClass->setWindowTitle(QApplication::translate("DeviceStateClass", "DeviceState", Q_NULLPTR));
        label->setText(QApplication::translate("DeviceStateClass", "Channel state", Q_NULLPTR));
        label_totalconnum->setText(QApplication::translate("DeviceStateClass", "Total link", Q_NULLPTR));
        label_devicestate->setText(QApplication::translate("DeviceStateClass", "Device state", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = disktableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("DeviceStateClass", "HD No.", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = disktableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("DeviceStateClass", "HD capacity(MB\357\274\211", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = disktableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("DeviceStateClass", "Last capacity(MB)", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = disktableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("DeviceStateClass", "HD state", Q_NULLPTR));
        label_nodename->setText(QApplication::translate("DeviceStateClass", "Device name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = channeltableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem4->setText(QApplication::translate("DeviceStateClass", "Channel No.", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = channeltableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem5->setText(QApplication::translate("DeviceStateClass", "Record state", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = channeltableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem6->setText(QApplication::translate("DeviceStateClass", "Signal state", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem7 = channeltableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem7->setText(QApplication::translate("DeviceStateClass", "Hardware state", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem8 = channeltableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem8->setText(QApplication::translate("DeviceStateClass", "Link number", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem9 = channeltableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem9->setText(QApplication::translate("DeviceStateClass", "Current bitrate", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem10 = channeltableWidget->horizontalHeaderItem(6);
        ___qtablewidgetitem10->setText(QApplication::translate("DeviceStateClass", "IPC links", Q_NULLPTR));
        pushButton_exit->setText(QApplication::translate("DeviceStateClass", "Exit", Q_NULLPTR));
        label_deviceIP->setText(QApplication::translate("DeviceStateClass", "Device IP", Q_NULLPTR));
        label_3->setText(QApplication::translate("DeviceStateClass", "Device state", Q_NULLPTR));
        label_2->setText(QApplication::translate("DeviceStateClass", "HDD state", Q_NULLPTR));
        pushButton_refresh->setText(QApplication::translate("DeviceStateClass", "Update", Q_NULLPTR));
    } // retranslateUi
