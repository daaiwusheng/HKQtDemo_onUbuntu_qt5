...
struct qt_meta_stringdata_CCompressAudio_t {
    QByteArrayData data[5];
    char stringdata0[58];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CCompressAudio_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CCompressAudio_t qt_meta_stringdata_CCompressAudio = {
    {
QT_MOC_LITERAL(0, 0, 14), // "CCompressAudio"
QT_MOC_LITERAL(1, 15, 9), // "clickSave"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12), // "clickRefresh"
QT_MOC_LITERAL(4, 39, 18) // "on_btnExit_clicked"

    },
    "CCompressAudio\0clickSave\0\0clickRefresh\0"
    "on_btnExit_clicked"
};
...
const QMetaObject CCompressAudio::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CCompressAudio.data,
      qt_meta_data_CCompressAudio,  qt_static_metacall, nullptr, nullptr}
};
...
void *CCompressAudio::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CCompressAudio.stringdata0))
