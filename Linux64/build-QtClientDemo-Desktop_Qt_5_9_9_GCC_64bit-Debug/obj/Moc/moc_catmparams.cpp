...
struct qt_meta_stringdata_CATMParams_t {
    QByteArrayData data[4];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CATMParams_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CATMParams_t qt_meta_stringdata_CATMParams = {
    {
QT_MOC_LITERAL(0, 0, 10), // "CATMParams"
QT_MOC_LITERAL(1, 11, 21), // "comboInputTypeChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 5) // "iType"

    },
    "CATMParams\0comboInputTypeChanged\0\0"
    "iType"
};
...
const QMetaObject CATMParams::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CATMParams.data,
      qt_meta_data_CATMParams,  qt_static_metacall, nullptr, nullptr}
};
...
void *CATMParams::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CATMParams.stringdata0))
