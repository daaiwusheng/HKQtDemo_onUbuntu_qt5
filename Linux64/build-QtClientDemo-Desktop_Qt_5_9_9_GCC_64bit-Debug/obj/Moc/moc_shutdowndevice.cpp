...
struct qt_meta_stringdata_ShutdownDevice_t {
    QByteArrayData data[4];
    char stringdata0[72];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ShutdownDevice_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ShutdownDevice_t qt_meta_stringdata_ShutdownDevice = {
    {
QT_MOC_LITERAL(0, 0, 14), // "ShutdownDevice"
QT_MOC_LITERAL(1, 15, 26), // "on_pushButton_sure_clicked"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 28) // "on_pushButton_cancel_clicked"

    },
    "ShutdownDevice\0on_pushButton_sure_clicked\0"
...
const QMetaObject ShutdownDevice::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ShutdownDevice.data,
      qt_meta_data_ShutdownDevice,  qt_static_metacall, nullptr, nullptr}
};
...
void *ShutdownDevice::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShutdownDevice.stringdata0))
