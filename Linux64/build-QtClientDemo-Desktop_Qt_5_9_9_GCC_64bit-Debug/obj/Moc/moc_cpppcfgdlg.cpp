...
struct qt_meta_stringdata_CPPPCfgDlg_t {
    QByteArrayData data[4];
    char stringdata0[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CPPPCfgDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CPPPCfgDlg_t qt_meta_stringdata_CPPPCfgDlg = {
    {
QT_MOC_LITERAL(0, 0, 10), // "CPPPCfgDlg"
QT_MOC_LITERAL(1, 11, 7), // "btnSave"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9) // "btncancel"

    },
    "CPPPCfgDlg\0btnSave\0\0btncancel"
};
...
const QMetaObject CPPPCfgDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CPPPCfgDlg.data,
      qt_meta_data_CPPPCfgDlg,  qt_static_metacall, nullptr, nullptr}
};
...
void *CPPPCfgDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CPPPCfgDlg.stringdata0))
